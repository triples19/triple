...
export module triple.math:matrix;
import :common;
import :vector;

import std;

export namespace triple::math {
...
class Matrix3x3 {
  ...
  public:
    ...
    Matrix3x3 operator*(const Matrix3x3& rhs) const {
        ...
        for (size_t row_index = 0; row_index < 3; row_index++) {
            for (size_t col_index = 0; col_index < 3; col_index++) {
                prod.mat[row_index][col_index] = mat[row_index][0] * rhs.mat[0][col_index] +
    ...
    Vector3 operator*(const Vector3& rhs) const {
        Vector3 prod;
        for (size_t row_index = 0; row_index < 3; row_index++) {
            prod[row_index] = mat[row_index][0] * rhs.x + mat[row_index][1] * rhs.y + mat[row_index][2] * rhs.z;
        }
        return prod;
    }
    ...
    friend Vector3 operator*(const Vector3& point, const Matrix3x3& rhs) {
        ...
        for (size_t row_index = 0; row_index < 3; row_index++) {
            prod[row_index] =
                point.x * rhs.mat[0][row_index] + point.y * rhs.mat[1][row_index] + point.z * rhs.mat[2][row_index];
        }
        return prod;
    }
...
Matrix4x4 look_at(const Vector3& from, const Vector3& to, const Vector3& up) {
    Vector3 x, y, z;
